...
### Definitions ###
# dataset
VCTK_PATH = "/datasets/vctk/"  # download:  https://datashare.ed.ac.uk/bitstream/handle/10283/3443/VCTK-Corpus-0.92.zipdddddddddd
...
dataset_config = BaseDatasetConfig(formatter="vctk_old", meta_file_train="", language="ur", path=VCTK_PATH)
...
config.audio_augmentation = {
    ...
    "p": 0,  # probability to the use of one of the augmentation - 0 means disabled
